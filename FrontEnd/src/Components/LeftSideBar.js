...
const LeftbarOptions = (props) => {
  ...
  return (
    <div className='sidebarOptions1'>
        <div className='sidebarOptions' onClick={() => {this.refreshPage(1)}}>
            <img
        ...
        <div className='sidebarOptions' onClick={() => {this.refreshPage(2)}}>
            <img
        ...
        <div className='sidebarOptions' onClick={() => {props.func('3')}}>
            <img
        ...
        <div className='sidebarOptions' onClick={() => {props.func('4')}}>
        <img
        ...
        <div className='sidebarOptions'  onClick={() => {props.func('5')}}>
        <img
        ...
        <div className='sidebarOptions' onClick={() => {props.func('6')}}>
        <img
        ...
        <div className='sidebarOptions' onClick={() => {props.func('7')}}>
        <img
        ...
        <div className='sidebarOptions' onClick={() => {props.func('8')}}>
        <img
