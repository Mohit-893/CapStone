    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark text-white fixed-top">
          <div className="container collapse navbar-collapse position-relative nav-item px-md-4">
            <div>
                {/* <img src={flake}  style={{height:'50px',width:'80px'}}/> */}
            ...
            <div className="row mx-md-n5 px-md-4">
                           <div className="col px-md-4">
                               <div className="p-2 bg-dark"><Link to={"/post"} style={{color:'goldenrod'}}><i className="bi bi-people-fill lead"></i></Link></div>
                           </div>
                           <div className="col px-md-4">
                               <div className="p-2 bg-dark"><Link to={"/post"} style={{color:'goldenrod'}}><i className="bi bi-bell  lead"></i></Link></div>
                           </div>
                           <div className="col px-md-4">
                               <div className="p-2 bg-dark"><Link to={"/post"} style={{color:'goldenrod'}}><i className="bi bi-clipboard2-check lead"></i></Link></div>
                           </div>
                           <div className="col px-md-4">
