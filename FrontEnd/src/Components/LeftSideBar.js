...
const LeftbarOptions = (props) => {
  return (
    <div className='sidebarOptions1'>
        <Link to={"/postbycatId"} className='removelink' state={{cat_id:1, islogin:(props.state), user:(props.user)}}>
        ...
        <Link to={"/postbycatId"} className='removelink' state={{cat_id:2, islogin:(props.state), user:(props.user)}}>
        <div className='sidebarOptions'>
            <img
        ...
        <Link to={"/postbycatId"} className='removelink' state={{cat_id:3, islogin:(props.state), user:(props.user)}}>
        <div className='sidebarOptions'>
            <img
        ...
        <Link to={"/postbycatId"} className='removelink' state={{cat_id:4, islogin:(props.state), user:(props.user)}}>
        <div className='sidebarOptions'>
        <img
        ...
        <Link to={"/postbycatId"} className='removelink' state={{cat_id:5, islogin:(props.state), user:(props.user)}}>
        <div className='sidebarOptions'>
        <img
        ...
        <Link to={"/postbycatId"} className='removelink' state={{cat_id:6, islogin:(props.state), user:(props.user)}}>
        <div className='sidebarOptions'>
        <img
        ...
        <Link to={"/postbycatId"} className='removelink' state={{cat_id:7, islogin:(props.state), user:(props.user)}}>
        <div className='sidebarOptions'>
        <img
        ...
        <Link to={"/postbycatId"} className='removelink' state={{cat_id:8, islogin:(props.state), user:(props.user)}}>
        <div className='sidebarOptions'>
        <img
